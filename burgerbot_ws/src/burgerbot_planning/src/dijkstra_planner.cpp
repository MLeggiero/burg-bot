...
#include "burgerbot_planning/dijkstra_planner.hpp"

namespace burgerbot_planning
{
...
PLUGINLIB_EXPORT_CLASS(burgerbot_planning::DijkstraPlanner, nav2_core::GlobalPlanner)